			...
			<section className='border-b'>
				<div className='container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl flex flex-col items-start gap-1 py-8 md:py-10 lg:py-12'>
					...
					<p className='max-w-2xl text-base font-light text-muted-foreground sm:text-lg'>
						A step-by-step guide for conducting basic accessibility testing
					</p>
				</div>
			</section>
												...
												<tbody className='text-sm'>
													<tr>
														...
														<td className='border p-2'>
															...
															who do not see the image, including: • People who are blind and use a
															screen reader • People with low vision that magnify the screen and use
															text-to-speech • Some people with learning or reading disabilities who
													...
													<tr>
														...
														<td className='border p-2'>
															...
															bookmarks/favorites • First thing read by screen readers when opening
															a page They help screen reader users understand what page is loading
															and navigate among open tabs.
														</td>
														<td className='border p-2'>
															<textarea
														...
														<td className='border p-2'>
															...
															the page content • Check that the title is different from other pages
															on the website • Verify that important and unique information comes
															first ("front-loading") Example of good titles: • "About Acme Web
															Solutions" (not "Acme Web Solutions - About Us") • "Contact Acme Web
															Solutions" (not "Acme Web Solutions - Contact Us")
														</td>
														<td className='border p-2'>
													...
													<tr>
														...
														<td className='border p-2'>
															Headings communicate the organization of the content on the page, like
															a table of contents. They should be nested by their rank/level
															(h1-h6). Headings are important for: • Screen reader users who can
															jump between headings with a single keystroke • People with low vision
															who rely on larger visual headings before zooming in • People with
															cognitive and learning disabilities who use headings to understand and
															focus on topics
														</td>
														<td className='border p-2'>
															<textarea
														...
														<td className='border p-2'>
															• Check for: • Presence of headings on the page • Page starts with an
															h1 • No skipped heading levels • No blank headings • Visual headings
															are marked up as actual headings • Heading text reflects the content
															that follows • Headings represent proper content structure, especially
															nested content
														</td>
														<td className='border p-2'>
													...
													<tr>
														...
														<td className='border p-2'>
															...
															Text and background color • Interactive elements and their background
															• Parts of graphs or charts that need to be understood Good contrast
															is important for: • People with low vision who have reduced contrast
															acuity • People with color deficient vision ('color blindness') •
															Anyone trying to read content in bright light conditions
														</td>
														<td className='border p-2'>
															<textarea
														...
														<td className='border p-2'>
															...
															way to convey information • Graphs and charts are understandable
															without relying on color Quick check: View page in grayscale to
															identify potential contrast issues
														</td>
														<td className='border p-2'>
													...
													<tr>
														...
														<td className='border p-2'>
															...
															instance is a skip navigation link at the start of a page. Skip links
															are important for: • Screen reader users • People with poor dexterity
															• People with various motor disabilities • People using mouth sticks
															or head pointers • People using switch devices
														</td>
														<td className='border p-2'>
															<textarea
														...
														<td className='border p-2'>
															...
															Skip link functionality works correctly • Link text clearly indicates
															purpose (e.g., "Skip navigation", "Skip to content", "Skip to main
													...
													<tr>
														...
														<td className='border p-2'>
															...
															dialogs/menus Check for: • Visible focus indicator on all interactive
															elements • No mouse-only interactions (e.g., hover menus) • Logical
															navigation order • Proper dialog behavior (navigation, closure, focus
															return) • No keyboard traps
														</td>
														<td className='border p-2'>
													...
													<tr>
														...
														<td className='border p-2'>
															...
															crucial because: • Screen readers and other text-to-speech tools need
															to know which language to use for correct pronunciation • Browser
													...
													<tr>
														...
														<td className='border p-2'>
															...
															menus are acceptable) • Confirm no horizontal scrolling is needed (for
															horizontal text) • Test all interactive elements still function
													...
													<tr>
														...
														<td className='border p-2'>
															...
															video. The audio in video content needs to be available to people who
															are Deaf or hard of hearing. Captions are important for: • People who
															are Deaf or hard of hearing • People watching video in noisy
															environments • People learning to read or learning the language •
														...
														<td className='border p-2'>
															...
															punctuated • Speaker identification when multiple people are speaking
													...
													<tr>
														...
														<td className='border p-2'>
															...
															information in audio content and available separately from the video.
															They are used by: • People who are Deaf or hard of hearing • People
															who have difficulty processing audio information • People who are
															deafblind • Screen reader users who may prefer reading the transcript
															over listening to audio • People who want to quickly scan or search
															through the content
														</td>
														<td className='border p-2'>
															<textarea
													...
													<tr>
														...
														<td className='border p-2'>
															...
															learning the language who benefit from additional verbal descriptions
														</td>
														<td className='border p-2'>
															<textarea
													...
													<tr>
														...
														<td className='border p-2'>
															...
															labels to understand how to interact with a form. Labels are
															especially important for: • Screen reader users who need to know what
															information to enter • People with cognitive disabilities who benefit
															from clear instructions • People with motor disabilities who need
															larger clickable areas • Anyone filling out forms who needs clear
															guidance
														</td>
														<td className='border p-2'>
															<textarea
													...
													<tr>
														...
														<td className='border p-2'>
															...
															disabilities who benefit from clear instructions • Anyone who wants to
															avoid form submission errors
														</td>
														<td className='border p-2'>
															<textarea
														...
														<td className='border p-2'>
															...
															all unmarked fields are required • Required fields are properly marked
															in HTML code (required attribute) • Error messages clearly indicate
													...
													<tr>
														...
														<td className='border p-2'>
															...
															the relationships between headers and data cells. This is important
															for: • Screen reader users who need to understand data relationships •
															People with cognitive disabilities who benefit from structured
															information • Users who need to navigate complex data efficiently •
															Anyone who needs to understand the logical relationships between data
															points
														</td>
														<td className='border p-2'>
															<textarea
													...
													<tr>
														...
														<td className='border p-2'>
															...
															document structure • People with reading difficulties who need clear,
															simple language • Users who scan content using headings and links
														</td>
														<td className='border p-2'>
															<textarea
														...
														<td className='border p-2'>
															...
															&lt;h1&gt; (only one per page) • Visual headings use proper hierarchy
															(&lt;h1&gt;, &lt;h2&gt;, etc.) without skipping levels • Link text is
															descriptive (avoid "read more" or "click here") • Plain language is
															used instead of jargon • Acronyms are spelled out on first reference •
															Content is organized in clear, logical sections
														</td>
														<td className='border p-2'>
													...
													<tr>
														...
														<td className='border p-2'>
															...
															Broken or empty links • Third-party widget behavior • Mobile-specific
															issues • Cross-browser compatibility • Custom component accessibility
															• Authentication flow accessibility • Error handling and messaging •
															Any other relevant aspects not covered by previous tests
														</td>
														<td className='border p-2'>
