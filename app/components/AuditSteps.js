...
export default function AuditSteps() {
	return (
		<div className='text-sm text-muted-foreground'>
			...
			<ul>
				<li className='py-2'>
					Before you start: Decide which automated tool you will use, eg. Silktide Accessibility
					Checker (great tool), Lighthouse, WAVE, etc. (also see Tool/Method column in the audit
					table).
				</li>
				...
				<li className='py-2'>Step 3. Add a summary of findings.</li>
				<li className='py-2'>
